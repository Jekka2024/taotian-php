...
class TaobaoItemsSellerListGetSku {
    ...
    public function getSkuFeature() : TaobaoItemsSellerListGetSkuFeature{
        return $this->sku_feature;
    }

    public function setSkuFeature(TaobaoItemsSellerListGetSkuFeature $skuFeature){
        $this->sku_feature = $skuFeature;
    }
