...
class TaobaoMessageChatrobotAsyncChatMessage {
    ...
    public function getSender() : TaobaoMessageChatrobotAsyncUser{
        return $this->sender;
    }

    public function setSender(TaobaoMessageChatrobotAsyncUser $sender){
        $this->sender = $sender;
    }
