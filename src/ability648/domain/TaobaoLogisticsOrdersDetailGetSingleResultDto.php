...
class TaobaoLogisticsOrdersDetailGetSingleResultDto {
    ...
    /**
        脱敏收件人电话
     **/
    public $receiver_phone_new;

    /**
        脱敏收件人手机号码
     **/
    public $receiver_mobile_new;
    ...
    public function getLocation() : TaobaoLogisticsOrdersDetailGetLocation{
        return $this->location;
    }

    public function setLocation(TaobaoLogisticsOrdersDetailGetLocation $location){
    ...
    public function getIsQuickCodOrder() : bool{
        return $this->is_quick_cod_order;
    }

    public function setIsQuickCodOrder(bool $isQuickCodOrder){
        $this->is_quick_cod_order = $isQuickCodOrder;
    }
    ...
    public function getReceiverPhoneNew() : string{
        return $this->receiver_phone_new;
    }

    public function setReceiverPhoneNew(string $receiverPhoneNew){
        $this->receiver_phone_new = $receiverPhoneNew;
    }

    public function getReceiverMobileNew() : string{
        return $this->receiver_mobile_new;
    }

    public function setReceiverMobileNew(string $receiverMobileNew){
        $this->receiver_mobile_new = $receiverMobileNew;
    }
