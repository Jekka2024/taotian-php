...
class TaobaoItemSellerGetItem {
    ...
    public function getDescModuleInfo() : TaobaoItemSellerGetDescModuleInfo{
        return $this->desc_module_info;
    }

    public function setDescModuleInfo(TaobaoItemSellerGetDescModuleInfo $descModuleInfo){
    ...
    public function getFoodSecurity() : TaobaoItemSellerGetFoodSecurity{
        return $this->food_security;
    }

    public function setFoodSecurity(TaobaoItemSellerGetFoodSecurity $foodSecurity){
    ...
    public function getLocalityLife() : TaobaoItemSellerGetLocalityLife{
        return $this->locality_life;
    }

    public function setLocalityLife(TaobaoItemSellerGetLocalityLife $localityLife){
        $this->locality_life = $localityLife;
    }

    public function getLocation() : TaobaoItemSellerGetLocation{
        return $this->location;
    }

    public function setLocation(TaobaoItemSellerGetLocation $location){
    ...
    public function getMpicVideo() : TaobaoItemSellerGetMpicVideo{
        return $this->mpic_video;
    }

    public function setMpicVideo(TaobaoItemSellerGetMpicVideo $mpicVideo){
    ...
    public function getPaimaiInfo() : TaobaoItemSellerGetPaimaiInfo{
        return $this->paimai_info;
    }

    public function setPaimaiInfo(TaobaoItemSellerGetPaimaiInfo $paimaiInfo){
    ...
    public function getCuntaoItemSpecific() : TaobaoItemSellerGetCuntaoItemSpecific{
        return $this->cuntao_item_specific;
    }

    public function setCuntaoItemSpecific(TaobaoItemSellerGetCuntaoItemSpecific $cuntaoItemSpecific){
        $this->cuntao_item_specific = $cuntaoItemSpecific;
    }

    public function getLargeScreenImageUrl() : string{
        return $this->large_screen_image_url;
    }

    public function setLargeScreenImageUrl(string $largeScreenImageUrl){
        $this->large_screen_image_url = $largeScreenImageUrl;
    }

    public function getIsAreaSale() : bool{
        return $this->is_area_sale;
    }

    public function setIsAreaSale(bool $isAreaSale){
        $this->is_area_sale = $isAreaSale;
    }

    public function getCpvMemo() : string{
        return $this->cpv_memo;
    }

    public function setCpvMemo(string $cpvMemo){
        $this->cpv_memo = $cpvMemo;
    }
